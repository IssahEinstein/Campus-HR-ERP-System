      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-lg font-medium">Upcoming &amp; Active</h2>
          </div>
          {upcoming.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="p-4 text-left font-medium text-gray-500">Shift</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {past.slice(0, 10).map((s) => (
                    <tr key={s.id} className="text-gray-400">
                      ...
                      <td className="p-4">{fmt(s.startTime)} · {fmtT(s.startTime)} – {fmtT(s.endTime)}</td>
